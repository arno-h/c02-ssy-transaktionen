...
// da wir sonst nicht wissen, welche Transaktion committed bzw. abgebrochen werden soll
...
function commit(req, resp) {
    // parseInt(), da req.params immer Strings sind,
    // für collection.get() aber String "3" !==  Int 3
